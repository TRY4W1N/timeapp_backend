...
from src.infrastructure.di.providers.auth import AppServiceProvider
...
def build_container() -> AsyncContainer:
    return make_async_container(ConfigProvider(), DatabaseProvider(), GatewayProvider(), AppServiceProvider())
