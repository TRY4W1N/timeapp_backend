...
async def test_stop_interval_ok(dl: Dataloader, fx_user: UserEntity, usecase_interval_track_stop: UsecaseIntervalTrackStop):
    # Arrange
    ...
    stopped_interval = await dl.interval_loader.get(fltr={"category_uuid": category_model.uuid, "user_uuid": fx_user.uuid})
